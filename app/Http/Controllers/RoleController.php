...
class RoleController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        if(!$oui){
            $good = false;
            $message .= "Veuillez Modifier Votre Role Car Déja Existant ! \n";
        }
        ...
        if(!$good){
            ...
            toastr()->success('Role Créer Avec Succèss !');
        ...
        //     'name.unique' => 'Veuillez Modifier Votre Role Car Déja Existant',
    ...
    public function update(Request $request, $id)
    {
        ...
        toastr()->success('Role Modifier Avec Succèss !');
